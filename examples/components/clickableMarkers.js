...
import Mark_Img from './current.png';
    ...
    return (
      <Map
        ...
        <Marker
          name="Robins Park"
          onClick={this.onMarkerClick}
          position={{ lat: 40.7485413, lng: -73.98575770000002 }}
        />
        <Marker name="Current location" icon = {{ url: 'current.png'}} onClick={this.onMarkerClick} />
